...
CONFIG="configs/training/scratch/model_1_7b_mp_fwe100k_en_min2_scratch.json"
RUN_DIR="out/pretrain_scratch/mp/1_7b_mp_fwe100k_en_min2_scratch_34b"
TOKENS_TARGET="34000000000"

mkdir -p "${RUN_DIR}"
LOG="logs/pretrain_scratch_1_7b_mp_fwe100k_34b_${PBS_JOBID}.log"

...
CONFIG="configs/training/scratch/model_1_7b_spm_100k_en_scratch.json"
RUN_DIR="out/pretrain_scratch/spm/1_7b_spm_100k_en_scratch_34b"
TOKENS_TARGET="34000000000"

mkdir -p "${RUN_DIR}"
LOG="logs/pretrain_scratch_1_7b_spm_34b_${PBS_JOBID}.log"
